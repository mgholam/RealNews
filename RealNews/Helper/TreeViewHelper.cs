...
namespace RealNews
{
    ...
    {
        public static TreeNode AddTreeNode(TreeView tree, string path, object tag, string title)
        {
            ...
            foreach (string subPath in path.Split(cachedpathseparator))
            {
                ...
                {
                    found = false;
                    var s = tree.Nodes.Find(subPath, true);
                    if (s.Length > 0)
                    {
                        found = true;
                        thisnode = s[0];
                    ...
                    else
                    {
                        ...
                        thisnode.Name = subPath;
                        thisnode.Text = subPath;
                    }
                    currentnode = thisnode;
                }
                else if (null == currentnode.Nodes[subPath])
